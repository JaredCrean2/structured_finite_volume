...
class StructuredBlockInterface
{
  public:
    ...
    const Range2D& getOwnedBoundaryVertsL() const { return m_owned_boundary_vertsL; }

    const Range2D& getOwnedBoundaryVertsR() const { return m_owned_boundary_vertsR; }
    ...
    const mesh::AdjacentBlockIndexer& getAdjBlockVertIndexerL() const { return m_vert_indexerL; }

    const mesh::AdjacentBlockIndexer& getAdjBlockVertIndexerR() const { return m_vert_indexerR; }

    const mesh::AdjacentBlockIndexer& getAdjBlockCellIndexerL() const { return m_cell_indexerL; }

    const mesh::AdjacentBlockIndexer& getAdjBlockCellIndexerR() const { return m_cell_indexerR; }
